...
public class VcrudConnectionRepository implements ConnectionRepository {
    ...
    public MultiValueMap<String, Connection<?>> findAllConnections() {
        List<Connection<?>> resultList = connectionMapper.mapEntities(
                getModelService().getModels(SocialUser_.user.getName(),
                        findUser(),
                        SocialUser.class,
                        null,
                        null)
    ...
    public List<Connection<?>> findConnections(String providerId) {
        ...
        List <SocialUser> resultCollection = getModelService().getModels(parameters, SocialUser.class, null, null);
    ...
    public MultiValueMap<String, Connection<?>> findConnectionsToUsers(MultiValueMap<String, String> providerUsers) {
        ...
        List<Connection<?>> resultList = connectionMapper.mapEntities(getSocialUserDao().findIn(findUser(),providerUsers));
    ...
    public Connection<?> getConnection(ConnectionKey connectionKey) {
        try {
            ...
            return connectionMapper.mapEntity(getModelService().getModel(parameters, SocialUser.class));
    ...
    public void addConnection(Connection<?> connection) {
        try {
            ...
            List <SocialUser> socialUsers = getModelService().getModels(parameters, SocialUser.class, null, null);
            ...
            getModelService().persist(socialUser);
    ...
    public void updateConnection(Connection<?> connection) {
        ...
        parameters.put(SocialUser_.providerId.getName(), data.getProviderId());
        parameters.put(SocialUser_.providerUserId.getName(), data.getProviderUserId());
        SocialUser socialUser = getModelService().getModel(parameters, SocialUser.class);
    ...
    public void removeConnections(String s) {
        ...
        for(SocialUser socialUser:socialUsers){
            getModelService().remove(socialUser);
        }
    }
    ...
    private User findUser(){
        if (currentUser==null){
            currentUser = getUserService().getUserByUsernameOrEmail(userId);
        }
        return currentUser;
    }
    ...
    public ModelService getModelService() {
        if (modelService == null){
            modelService = ApplicationContextProvider.getApplicationContext().getBean(ModelService.class);
        }
        return modelService;
    }
    ...
    public SocialUserDao getSocialUserDao() {
        if (socialUserDao == null){
            socialUserDao = ApplicationContextProvider.getApplicationContext().getBean(SocialUserDao.class);
        }
